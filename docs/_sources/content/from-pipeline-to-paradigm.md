...
Figure 1. The Standard Sequence as a Narrative Arc
```
...
Figure 2. The Arc Transposed
```
With this visualization, we can discern some interesting properties about the data
...
Figure 3. The Integrative Role of Practice
```
...
Figure 4. The Four Areas in Two Dimensions
```
...
Figure 5. The 4+1 Model of Data Science
```
The
